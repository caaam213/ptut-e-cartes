//PARTIE 1
    ...
    document.getElementById("lien").addEventListener("click", function(e){
        ...
        var saisie2 = document.getElementById("idCrit").value;
        var changement = document.getElementById("lien"); 
        changement.setAttribute('href','index.php?page=gestionCriteres&nomModif=' + saisie + '&idModif='+ saisie2);
    });
...
//PARTIE2 
    ...
    document.getElementById("lien2").addEventListener("click", function(e){
        ...
        var saisie3 = document.getElementById("idCrit2").value;
        var changement2 = document.getElementById("lien2"); 
        changement2.setAttribute('href','index.php?page=gestionCriteres&nomModif=' + saisie2 + '&idModif='+ saisie3);
